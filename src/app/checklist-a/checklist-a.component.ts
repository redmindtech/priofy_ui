...
export class ChecklistAComponent implements OnInit {
 ...
 oot_high_pressure_text:['1.OOT to ensure treated high pressure BFW (140 kg/cm2g HBF) is available.'],
 oot_hbf_inlet_text:['2.HBF inlet DB 1" drains.'],
 oot_downstream_1_drains_text:['FV-22X6-08 downstream 1" drains.'],
 oot_bypass_text:['FV-22X6-08 bypass 1" drains.'],
 oot_inlet_vents_text:['ECO inlet 1 vents.'],
 oot_outlet_drains_text:['ECO outlet 1" drains.'],
 oot_stream_drum_inlet_check_text:['Steam Drum Inlet Check Valve 1" drains.'],
 oot_untreated_inlet_db_1_text:['Untreated HBF Inlet DB 1 drains.'],
 oot_untreated_hbf_inlet_check_text:['Untreated HBF Inlet Check Valve 1" drains.'],
 oot_hpssh_2_Outlet_text:['HPSSH-2 Outlet 1-1/2" drains.'],
 oot_hxs_upstream_nrv_text:['HXS line upstream NRV (non-return valve).'],
 oot_vent_silencer_upstream_text:['Vent Silencer PV-22X0-43 upstream 1 drains.'],
 oot_vent_silencer_downstream_text:['Vent Silencer PV-22X0-43 downstream 1" drain.'],
 oot_hxs_outlet_text:['HXS outlet DB 1" drains.'],
 oot_sdl_transmitters_text:['Steam Drum Level Transmitters (#3) 1" drains and vents.'],
 oot_sdi_blow_down_text:['2" Steam Drum Intermittent Blow down (#2).'],
 oot_bd_header_text:['Steam Drum Continuous BD Header DB 1" drains'],
 oot_secondary_tle_text:['Secondary TLE Continuous BD Header DB 1" drains.'],
 oot_intermittent_bd_header_text :['Intermittent BD Header B/V 1" drains'],
 oot_primary_tles_2_text:['Primary TLEs 2" blow downs (#12).'],
 oot_secondary_tle_1_text :['Secondary TLE 1 blow downs (#2)'],
 oot_primary_tles_commom_header_text:['Primary TLEs Common Header 1" bleeds'],
 iot_decoke_mov_text:['3.IOT to ensure that Decoke MOV is open, CG MOVs are closed and the local MOV switches are in REMOTE position.'],
 iot_furnace_control_sequence_text:['4.IOT to ensure Furnace control sequence is in Process Wait step.'],
 iot_bm_sequence_text:['5.IOT to move BM sequence to Process Wait step.'],
 iot_individual_auto_burner_text:['6.IOT to go to each individual auto burner and move its sequence to Process Wait.'],
 oot_feed_and_fuel_gas_text:['7.OOT to double check that feed and fuel gas are isolated.'],
 iot_bm_control_sequence_to_stand_text:['8.IOT to move BM control sequence to Stand By step.'],
 iot_purge_light_off_text:['9.Once BMS is moved to Standby, IOT can manually move Furnace control sequence step from process wait to purge light off.'],
 oot_open_and_car_sealed_text:['10.OOT to ensure steam drum BFW inlet B/V at the inlet of steam drum is open and car sealed (on top deck).'],
 oot_second_bv_text:['11.OOT to ensure furnace battery limit HBF inlet 4" second B/V is closed.<br>Note: First B/V should not be operated (it should be always open).'],
 oot_upstream_and_downstram_bv_open_text:['12.OOT to ensure HBF control valve (FV-22X6-08) upstream and downstream B/Vs are open.'],
 oot_bv_and_globe_value_close_text:['13.OOT to ensure HBF control valve (FV-22X6-08) bypass 2 B/V and globe valve are closed.'],
 drum_3_startup_vent_text:['14.Keep the steam drum 3" startup vent valves open.'],
 oot_hxs_vent_valve_text:['15.OOT to open both HXS vent valve PV-22X0-43 4" upstream block valves.'],
 iot_default_pressure_text:['16.IOT to ensure PV-22X0-43 is in "auto" control at the default flow set point of 10 Mt/h and default pressure set point of 112 kg/cm2g.'],
 pressurize_the_downstream_text:['17.Initially use the bypass valves across first block valve to pressurize the downstream header and then open the main block valve. Then close the bypass valves across the first block valve.Start taking BFW to steam drum through FV-22X6-08 2" bypass line, keeping first bypass open and throttling 2nd bypass valve.'],
 iot_filling_the_steam_drum_text:['18.IOT to start filling the steam drum SLOWLY. Must enable “BFW to steam drum flow control slave” controller through activation of the HS.'],
 iot_steam_drum_level_control_master_text:['19.IOT to confirm that “steam drum level control master” controller is automatically enabled after level has been within 5% of fill set point'],
