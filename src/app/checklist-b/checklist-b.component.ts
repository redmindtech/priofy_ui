...
formInitialization(){
  ...
  this.ChecklistB= this.fb.group({
    ...
    iot_fan_motor_readings_text:['12.Has IOT checked ID fan/motor vibration readings are within the acceptable limits and NO alarms.'],
    ...
    iot_FD_fan_motor_readings_text:['18.Has IOT checked FD fan/motor vibration readings are within the acceptable limits and NO alarms.'],
