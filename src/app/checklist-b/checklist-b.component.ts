...
formInitialization(){
  ...
  this.ChecklistB= this.fb.group({
    oot_bearings_oil_levels_text:['1. Has OOT confirmed that both fan bearings oil levels cups are filled to normal'],
    iot_Overview_HMI_text:['2.Has IOT confirmed that the VFDs are powered up and the motors are energized in the MCC at the Fan Overview HMI (ready DI from motor and alarm signal from VSD).'],
    ups_system_text:['3.Confirm that pure wave UPS system is up and running. Check with Electrician is required for confirmation.  '],
    oot_caged_doors_open_text:['4.Has OOT confirmed that each drop out door area is caged and both doors are open.'],
    oot_peep_doors_closed_text:['5.Has OOT confirmed all peep doors at all levels are closed and levers  installed.'],
    oot_local_start_stop_text:['6.Has OOT placed local “start-stop” switch in “auto” for both fans.'],
    oot_ID_fan_casing_text:['7.Has OOT checked that whether the ID fan casing 1” drain valve is closed.'],
    oot_FD_suction_text:['8.Has OOT checked that the FD suction 2” B/V and casing 2” drain valve are both closed.'],
    oot_Floor_burners_text:['9.step1:*Floor burners (bottom level) open, except ALL 4 auto burners.'],
    oot_Wall_burners_text :['9.step2:*Wall burners (top level) closed.'],
    iot_start_ID_fan_text:['10.Has the IOT started ID fan.'],
    iot_ID_fan_running_text:['11.Has IOTs ensured the ID fan is running.'],
    iot_FD_fan_motor_readings_text:['12.Has IOT checked ID fan/motor vibration readings are within the acceptable limits and NO alarms.'],
    oot_ID_fan_abnormality_text:['13.Has OOT checked the ID fan for any abnormality in the field.'],
    oot_four_air_duct_text:['14.Has the OOT confirmed that the four air duct “chain valves” to each burner side are open.'],
    iot_start_FD_text:['15.Has IOT started FD fan.'],
    iot_FD_fan_running_text:['16.Has IOT ensured the FD fan is running.'],
    iot_FC_signal_text:['17.Step 1: put FC signal in manual at 50% to achieve a FD fan speed higher than 475 rpm.'],
    iot_close_the_doors_text:['17.Step 2: close the doors.'],
    iot_FC_back_in_auto_text:['17.Step 3: put the FC back in auto.'],
    iot_fan_motor_readings_text:['18.Has IOT checked FD fan/motor vibration readings are within the acceptable limits and NO alarms.'],
    oot_FD_shaft_speed_text:['19.Has OOT checked that the FD fan vibration and shaft speed local indicators are operational.'],
    oot_FD_fan_abnormality_text:['20.Has OOT checked the FD fan for any abnormality in the field.'],
    oot_LS_Steam_condensate_text:['21.Has OOT ensured LS steam / condensate main block valve at the furnace battery limit are open and LS is lined up to HV-22X6-13B seat.'],
    oot_S_TLE_text:['22.Step1:*S-TLE inlet PT-22X5-05.'],
    oot_T_TLE_text:['22.Step2:*T-TLE outlet PT-22X6-01 and PT-22X6-02.'],
    oot_CG_MOVs_intermediate_text:['22.Step3:*CG MOVs intermediate PT-22X6-07 (also HV-22X6-15 must be closed).'],
    oot_CG_HV_22X6_13A_text:['22.Step4:*CG MOVs HV-22X6-13A.'],
    oot_Decoke_MOV_text:['22.Step5:*Decoke MOV HV-22X6-14.'],
    oot_Double_Block_text:['23.OOT ensure that LS Purge to Instruments 2” Double Block is open.'],
    oot_LS_purge_lined_up_text:['24.OOT ensure that all LS purge system steam traps are lined up and operational.'],
    ms_Steam_text:['25.Ensure that MS Steam is available.'],
    fgs_ready_text:['26.Ensure that Fuel Gas system is ready.'],
    oot_burners_manual_BV_text:['27.Has OOT ensured that all burners manual B/V and all four HV-automated burner valves are closed.'],
    oot_ignitor_and_flame_scanner_text:['28.Has OOT ensured that ignitor and flame scanner Instrument Air purges are on. '],
    oot_fourth_platform_level_text:['29.Step1:*2” main B/V at fourth platform level.'],
    oot_1_BV_to_AT_22X0_11A_text:['29.Step2:*1” B/V to AT-22X0-11A.'],
    oot_1_BV_to_AT_22X0_11B_text:['29.Step3:*1” B/V to AT-22X0-11B.'],
    oot_34_BV_to_AP_22X0_11A_text:['29.Step4:*3/4” B/V to AP-22X0-11A.'],
    oot_34_BV_to_AP_22X0_11B_text:['29.Step5:*3/4” B/V to AP-22X0-11B.'],
    iot_ignitors_and_flame_scanners_text:['30.Has IOT ensured that ignitors and flame scanners are energized. Check for the “HEALTHY” indication on the HMI '],
    blow_down_HXS_header_text:['31.Drain any condensate from the furnace HXS header as per the procedure 202-06-R-01 Furnace F-22_0, Blow down HXS header.'],
    oot_10_block_valves_text:['32.Step1:*Both 10” block valves.'],
    oot_8_NRV_valve_text:['32.Step2:*8” NRV valve.'],
    iot_SD_level_text:['33.IOT to ensure that steam drum level is between 42%-60%.'],
    oot_bleed_to_flare_text:['34.OOT to double check that ethane feed DB & B (bleed to flare) is closed.'],
